...
|---|---|---|
| **robust-implementation** | deep-work + deep-review detected | Phase-by-phase implementation (Research→Spec→Plan→Implement→Test) with Plan approval gate, deep-review-loop APPROVE verdict, and test pass as termination |
